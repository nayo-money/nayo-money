...
export default async function Buy(){
 const supabase=await createClient();let setting:any=null;if(supabase){const {data}=await supabase.from("site_settings").select("primary_label,primary_url,secondary_label,secondary_url").eq("id",true).maybeSingle();setting=data}
